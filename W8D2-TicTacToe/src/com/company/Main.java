...
class Main {
    ...
    public static void drawBoard(char[][] board) {
        ...
        for(int i = 0; i < 3; i++) {
            ...
            // This print statement adds a new line so that each row is on a separate line
            System.out.println();
        }
    }

    // Create function to see if someone has won and return the winning char
    ...
    // Create function to check if all of the positions on the board have been filled
